...
export default function Exercises() {
    ...
    const renderTitle = () => {
        ...
        if (queryParams.muscle && queryParams.equipment && queryParams.difficulty) {
            return `Exercicios ${queryParams.difficulty + 's'} para ${queryParams.muscle} usando ${queryParams.equipment}`;
        }
        ...
        if (queryParams.difficulty) return `Exercícios ${queryParams.difficulty + 's '}`;
        else {
